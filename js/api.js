...
(function () {
  ...
  function renderCases(cases) {
    ...
    var html = cases
      .map(function (c, idx) {
        ...
        var hiddenClass = idx >= 3 ? " is-hidden-load" : "";
        var mediaInner = img
    ...
    var html = reviews
      .map(function (r) {
        return (
          ...
          "</span>" +
          "</footer>" +
          '<p class="review-grid-card__source">Источник: <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer">Google</a> / <a href="https://2gis.kg" target="_blank" rel="noopener noreferrer">2GIS</a></p>' +
          "</article>" +
          "</li>"
        );
      })
  ...
  function bootstrapReviews() {
    var list = document.getElementById("reviews-text-list");
    if (!list || list.hasAttribute("data-static-reviews")) {
      return;
    }
    (async function () {
      try {
